...
v0 is a **verbatim extraction** of the already-provider-neutral core of
[`jumpdrive-runner`](https://github.com/rarebit-one/jumpdrive-runner) — behavior
is intentionally identical to that runner's. Seam-widening (a general
`ModelInvocation` seam, streaming, multimodal input, middleware, context
providers) is planned as an additive v0.2.
